...
/**
 * Загружаем Sgf из сети в GameTree.
 */
CGoBoardApi.prototype.Load_SgfByUrl = function(oGameTree, sSgfFile, _oViewPort, sMoveReference, sExt)
{
    var oViewPort = {};
    ...
    var nOldFlags = oGameTree.m_nEditingFlags;
    oGameTree.Reset_EditingFlags();
    oGameTree.Load_SgfByUrl(sSgfUrl, oViewPort, sMoveReference, sExt);
    oGameTree.m_nEditingFlags = nOldFlags;
};
