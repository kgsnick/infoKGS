...
function CDrawingButtonBase(oDrawing)
{
    ...
    this.m_oNormaBColor    = new CColor(63, 81, 181, 255);
    this.m_oNormaFColor    = new CColor(255, 255, 255, 255);
    this.m_oHoverBColor    = new CColor(63, 81, 181, 102);
    this.m_oHoverFColor    = new CColor(255, 255, 255, 255);
    this.m_oActiveBColor   = new CColor(255, 103, 0, 255);
    this.m_oActiveFColor   = new CColor(255, 255, 255, 255);
    this.m_oDisabledBColor = new CColor(63, 81, 181, 255);
    this.m_oDisabledFColor = new CColor(63, 81, 181, 255);
    this.m_oSelectedBColor = new CColor(63, 81, 181, 255);
