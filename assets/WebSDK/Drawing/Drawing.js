...
CSettings.prototype.Load_FromLocalStorage = function()
{
    ...
    var eColorScheme = EColorScheme.SimpleColor;
...
CDrawing.prototype.Create_Viewer = function(sDivId)
{
    ...
    oDrawingToolbar.Add_Control(new CDrawingButtonBackwardToStart(this), 36, 5, EToolbarFloat.Left);
    oDrawingToolbar.Add_Control(new CDrawingButtonBackward5(this), 36, 5, EToolbarFloat.Left);
    oDrawingToolbar.Add_Control(new CDrawingButtonBackward(this), 36, 5, EToolbarFloat.Left);
    oDrawingToolbar.Add_Control(new CDrawingButtonForward(this), 36, 5, EToolbarFloat.Left);
    oDrawingToolbar.Add_Control(new CDrawingButtonForward5(this), 36, 5, EToolbarFloat.Left);
    oDrawingToolbar.Add_Control(new CDrawingButtonForwardToEnd(this), 36, 5, EToolbarFloat.Left);
