...
function CDrawingWindow()
{
    ...
    this.m_oOuterBorderColor = new CColor(63, 81, 181, 255);
    this.m_oInnerBorderColor = new CColor(63, 81, 181, 255);
    this.m_oBackColor        = new CColor(63, 81, 181, 255);
...
CDrawingWindow.prototype.Init = function(sDivId, bResizable)
{
    ...
    oMainDiv.style.boxShadow       = "0px 1px 10px rgba(0,0,0,0.8)";
